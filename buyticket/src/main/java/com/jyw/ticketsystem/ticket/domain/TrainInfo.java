...
public class TrainInfo {
    ...
    public TrainInfo(String traincode, int start_NO, int end_NO) {
        this.traincode = traincode;
        this.start_NO = start_NO;
        this.end_NO = end_NO;
    }

    public TrainInfo(String traincode, String start_station, String end_station, String start_time, String end_time, int start_NO, int end_NO) {
        this.traincode = traincode;
        this.start_station = start_station;
        this.end_station = end_station;
        this.start_time = start_time;
